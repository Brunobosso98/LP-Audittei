        ...
        <div className="grid gap-12 lg:grid-cols-[1fr_1fr] lg:gap-16">
          <div>
            ...
            <h2 className="mt-4 text-balance text-4xl font-medium leading-[1.05] tracking-[-0.035em] text-foreground sm:text-5xl lg:text-[3.5rem]">
              Veja o Auditor Fiscal rodando em um cliente da sua carteira
            </h2>
            <p className="mt-5 text-lg leading-relaxed text-muted-foreground">
              Em 30 minutos, a Inttax roda o Auditor Fiscal sobre um cliente real. Você sai com as
              exceções priorizadas, o resumo executivo e o material pronto para abrir a próxima
              reunião e justificar a próxima fatura do contrato.
            </p>
