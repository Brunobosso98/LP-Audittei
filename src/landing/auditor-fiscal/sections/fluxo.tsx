import { ClipboardCheck, FileSearch, Presentation, Users } from "lucide-react"
...
const PASSOS: Passo[] = [
  {
    n: "01",
    icon: FileSearch,
    titulo: "Importar NF-e e SPED",
    descricao:
      "NF-e de entrada, saída e SPED entram pela integração com o ERP do escritório. Sem migração, sem reformatação, sem retrabalho.",
    meta: "Janela de leitura: até 60s por cliente",
  },
  {
    n: "02",
    icon: ClipboardCheck,
    titulo: "Cruzar com a legislação",
    descricao:
      "Cada operação é confrontada com a legislação vigente, com o regime declarado e com o histórico do próprio cliente. Exceções ganham contexto antes de virar pendência.",
    meta: "Atualização contínua conforme ajustes do CONFAZ",
  },
  {
    n: "03",
    icon: Users,
    titulo: "Distribuir por analista",
    descricao:
      "Exceções são pesadas e distribuídas conforme o perfil do analista. SLA por cliente e por tributo ficam visíveis para a gestão do escritório.",
    meta: "Operação em escala, fim do achismo",
  },
  {
    n: "04",
    icon: Presentation,
    ...
    descricao:
      "O resumo executivo sai pronto para abrir a reunião com o cliente: cenário antes e depois, top NCMs sensíveis, ranking de risco e o plano de ação fechado. É o que o cliente reconhece como consultoria estratégica, e o que o seu escritório fatura como contrato.",
